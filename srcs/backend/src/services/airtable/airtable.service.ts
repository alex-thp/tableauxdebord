    ...
    async getDatabase() {
        try {
          ...
          const tab = Promise.all([
            ...
            this.getJsonFromTable(process.env.TABLE_SOUS_DOSSIER_FI, "SOUS_DOSSIER_FI"),
            this.getJsonFromTable(process.env.TABLE_RAPPORT, "RAPPORT"),
            this.getJsonFromTable(process.env.TABLE_RAPPORT_X_INDICATEUR, "RAPPORT_X_INDICATEUR"),
            this.getJsonFromTable(process.env.TABLE_INDICATEUR, "INDICATEUR"),
            this.getJsonFromTable(process.env.TABLE_SOUS_DOSSIER_FI_X_STRUCTURE_BENEFICIAIRE, "SOUS_DOSSIER_FI_X_STRUCTURE_BENEFICIAIRE"),
            this.getJsonFromTable(process.env.TABLE_CDP_ENR_CAND, "CDP_ENR_CAND"),
            this.getJsonFromTable(process.env.TABLE_AT_CO_ENR_CAND, "AT_CO_ENR_CAND"),
            this.getJsonFromTable(process.env.TABLE_BIEN_ETRE, "BIEN_ETRE"),
            this.getJsonFromTable(process.env.TABLE_BIEN_ETRE_ENR_CAND, "BIEN_ETRE_ENR_CAND"),
            ...
            this.getJsonFromTable(process.env.TABLE_CONTACT_DE_STRUCTURE, "CONTACT_DE_STRUCTURE"),
            this.getJsonFromTable(process.env.TABLE_CDP_SUIVI_CANDIDAT, "CDP_SUIVI_CANDIDAT"),
            this.getJsonFromTable(process.env.TABLE_CDP_ENR_CAND_X_CDP_ENR_BENEV, "CDP_ENR_CAND_X_CDP_ENR_BENEV"),
            ...
            this.getJsonFromTable(process.env.TABLE_EVENEMENT_BENEV, "EVENEMENT_BENEV"),
            this.getJsonFromTable(process.env.TABLE_EVENEMENT_BENEV_X_BENEV, "EVENEMENT_BENEV_X_BENEV"),
          ]);
