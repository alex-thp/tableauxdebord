...
export class DevGatewayService {
  ...
  getVisualisationValue(
    ...
    const reponse = this.http.get(`${this.baseUrl}/indicateurValue`, {
      params,
    });
    return reponse;
  }
  ...
  getIndicateurValuePublic(formulaire: FormGroup): Observable<any> {
    ...
    console.log(
      'getIndicateurValuePublic called with parameters:',
      params.toString()
    );
    return this.http.get(`${this.sharedUrl}/indicateurValue-public`, {
      params,
    });
  }
}
