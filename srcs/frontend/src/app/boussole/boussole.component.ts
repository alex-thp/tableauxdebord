...
export class BoussoleComponent implements OnInit {
  ...
  constructor(
    private boussoleService: BoussoleService,
  ...
  ngAfterViewInit() {
    setTimeout(() => {
      // petit délai pour être sûr que tout est rendu
      let maxHeight = 0;
  ...
  loadBoussoleLastYearData() {
    ...
    this.boussoleService
      .getBoussoleData(dateDebut, dateFin)
      .subscribe((data) => {
        ...
        this.old_taux_presence_cdp =
          acomp.nb_cand_cdp_fixe + acomp.nb_cand_cdp_mobile > 0
            ? ((acomp.nb_cand_cdp_fixe + acomp.nb_cand_cdp_mobile) /
                (acomp.nb_cand_cdp_fixe +
                  acomp.nb_cand_cdp_mobile +
                  acomp.nb_absent_cdp)) *
              100
            : 0;
        this.old_taux_presence_bien_etre =
          acomp.nb_cand_bien_etre > 0
            ? (acomp.nb_cand_bien_etre /
                (acomp.nb_cand_bien_etre + acomp.nb_absent_bien_etre)) *
              100
            : 0;

        this.old_taux_qpv_fixe =
          acomp.nb_cand_cdp_fixe > 0
            ? (acomp.nb_cand_qpv_fixe / acomp.nb_cand_cdp_fixe) * 100
            : 0;
        this.old_taux_qpv_mobile =
          acomp.nb_cand_cdp_mobile > 0
            ? (acomp.nb_cand_qpv_mobile / acomp.nb_cand_cdp_mobile) * 100
            : 0;
        this.old_taux_qpv_total =
          ((acomp.nb_cand_qpv_fixe + acomp.nb_cand_qpv_mobile) /
            (acomp.nb_cand_cdp_fixe + acomp.nb_cand_cdp_mobile)) *
          100;

        this.old_taux_fin_parcours =
          this.old_boussoleData.accompagnement
            .taux_sortie_positive_fin_parcours +
            this.old_boussoleData.accompagnement
              .taux_sortie_negative_fin_parcours >
          0
            ? (this.old_boussoleData.accompagnement
                .taux_sortie_positive_fin_parcours /
                (this.old_boussoleData.accompagnement
            ...
            : 0;
        this.old_taux_remob =
          this.old_boussoleData.accompagnement.taux_sortie_positive_remob +
            this.old_boussoleData.accompagnement.taux_sortie_negative_remob >
          0
            ? (this.old_boussoleData.accompagnement.taux_sortie_positive_remob /
                (this.old_boussoleData.accompagnement
                  .taux_sortie_positive_remob +
                  this.old_boussoleData.accompagnement
                    .taux_sortie_negative_remob)) *
              100
            : 0;

        this.old_pourcent_fin_parcours =
          (this.old_boussoleData.accompagnement.nb_fin_parcours /
            (this.old_boussoleData.accompagnement.nb_fin_parcours +
              this.old_boussoleData.accompagnement.nb_remob)) *
          100;
        this.old_pourcent_remob =
          (this.old_boussoleData.accompagnement.nb_remob /
            (this.old_boussoleData.accompagnement.nb_fin_parcours +
              this.old_boussoleData.accompagnement.nb_remob)) *
          100;
        this.old_pourcent_fin_parcours_string =
          this.old_pourcent_fin_parcours.toFixed(2);
        this.old_pourcent_remob_string = this.old_pourcent_remob.toFixed(2);

        this.old_taux_cdp_et_at_co =
          acomp.nb_cand_at_co > 0
            ? (acomp.nb_cand_unique_at_co_avec_cdp /
                acomp.nb_cand_unique_at_co) *
              100
            : 0;
        this.old_taux_cdp_et_at_co = this.old_taux_cdp_et_at_co.toFixed(
          2
  ...
  loadBoussoleData() {
    ...
    this.boussoleService
      ...
      .subscribe((data) => {
        ...
        this.taux_fin_parcours =
          this.boussoleData.accompagnement.taux_sortie_positive_fin_parcours +
            this.boussoleData.accompagnement.taux_sortie_negative_fin_parcours >
          0
            ? (this.boussoleData.accompagnement
                .taux_sortie_positive_fin_parcours /
                (this.boussoleData.accompagnement
                  .taux_sortie_positive_fin_parcours +
                  this.boussoleData.accompagnement
            ...
            : 0;
        this.taux_remob =
          this.boussoleData.accompagnement.taux_sortie_positive_remob +
            this.boussoleData.accompagnement.taux_sortie_negative_remob >
          0
            ? (this.boussoleData.accompagnement.taux_sortie_positive_remob /
                (this.boussoleData.accompagnement.taux_sortie_positive_remob +
                  this.boussoleData.accompagnement
        ...
        this.pourcent_fin_parcours =
          (this.boussoleData.accompagnement.nb_fin_parcours /
            (this.boussoleData.accompagnement.nb_fin_parcours +
              this.boussoleData.accompagnement.nb_remob)) *
          100;
        this.pourcent_remob =
          (this.boussoleData.accompagnement.nb_remob /
            (this.boussoleData.accompagnement.nb_fin_parcours +
              this.boussoleData.accompagnement.nb_remob)) *
          100;
        this.pourcent_fin_parcours_string =
          this.pourcent_fin_parcours.toFixed(2);
        this.pourcent_remob_string = this.pourcent_remob.toFixed(2);

        this.taux_cdp_et_at_co =
          acomp.nb_cand_at_co > 0
            ? (acomp.nb_cand_unique_at_co_avec_cdp /
                acomp.nb_cand_unique_at_co) *
              100
            : 0;
        this.taux_cdp_et_at_co = this.taux_cdp_et_at_co.toFixed(
          2
        ) as unknown as number;

        this.taux_cdp_et_at_co_objectif =
          acomp.nb_cand_at_co > 0
            ? (210 / acomp.nb_cand_unique_at_co) * 100
            : 0; // objectif annuel
        this.taux_cdp_et_at_co_objectif =
          this.taux_cdp_et_at_co_objectif.toFixed(2) as unknown as number;
      });
  }
